...
export default async function StackPicker() {
	const fakeApi = await readFile('/src/components/fakeapi/options_for_stackpicker_v2');
	const fakeApiBackendAddons = await readFile('/src/components/fakeApi/backend_addons');
